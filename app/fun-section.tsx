  ...
  return (
    <TooltipProvider>
      <Tooltip>
        ...
        >
          <p className="text-body-small font-medium">{tooltip}</p>
          {/* Sticky note corner */}
...
export default function FunSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-screen w-full flex flex-col lg:flex-row items-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20"
    >
      {/* Background elements */}
      <MovingStars />
      <GalaxyBackground />
      ...
      >
        <div className="max-w-lg mx-auto lg:mx-0">
          <motion.h2
            className="heading-section tracking-wide mb-4"
          ...
          <motion.p
            className="heading-medium text-light mb-12"
